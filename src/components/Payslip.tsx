...
const Payslip: React.FC<PayslipProps> = ({ data }) => {
  ...
  return (
    <div 
      className="payslip-container mx-auto bg-white shadow-xl rounded-lg border border-gray-200 mb-8 flex flex-col justify-between shrink-0"
      style={{ 
        width: '794px',   // Strict A4 Width at 96dpi
        height: '1123px', // Strict A4 Height at 96dpi
        padding: '60px'   // Generous print margins
      }}
    >
        {/* TOP SECTION: Wraps Header, Details, and Tables so they stay together */}
        <div>
            ...
            <section className="mt-8 pt-6 border-t-2 border-gray-800 flex flex-col items-center">
                <div className="w-full bg-blue-50 border border-blue-200 rounded-lg p-6 flex items-center justify-between">
                    <div>
        ...
        {/* BOTTOM SECTION: Flexbox pushes this to the very bottom of the 1123px height */}
        <footer className="mt-auto pt-8 flex justify-between items-end border-t border-gray-200 text-sm text-gray-500">
            <div>
